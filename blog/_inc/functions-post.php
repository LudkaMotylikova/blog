<?php
	 ...
	 * I can add WHERE conditions too
	 *
	 * @param  string $where
	 * @return string
	 */
	 ...
	 * Get All Tags
	 *
	 * Grab tags, if I wanna add them to like an input/edit form
	 * If $post_id is provided, I mark which tags belong to this post
	 *
	...
	function validate_post()
	{
		...
		// if have error messages, validation didn't go well
